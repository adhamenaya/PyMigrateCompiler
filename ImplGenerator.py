...
class Generator:
    ...
    def insert_function_list(self,function):
        ...
        self.add_line("        public Task<ICollection<"+return_type+">> "+function_name+"("+input_params_str+")")
        #self.add_line("        {")
    ...
    def run(self, package_name,extra):
        ...
        p = Parser()
        vb = p.read_file_as_one_line("Instrument\\"+package_name+".txt")
